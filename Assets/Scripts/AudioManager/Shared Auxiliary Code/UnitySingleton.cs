    ...
    where T : MonoBehaviour
{
...
#endif
    {
        ...
        {
#if UNITY_EDITOR
            Debug.LogWarning( "Input Manager: Only one Input Manager may exist in a scene. This additional Input Manager game object will be deleted. You may see this warning if you are loading a new level that contains a Input Manager. If that's the case, you can safely ignore this warning. This warning will never be logged in a build. ");
